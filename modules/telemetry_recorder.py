...
class TelemetryRecorder:
    ...
    def start_recording(self) -> None:
        ...
        try:
            ...
            self._writer = None  # lazily initialized on first write (needs header)
    ...
    def write_frame(
        ...
        """Write one telemetry frame. Never raises — errors are swallowed.
        ...
        try:
            ...
            # Lazy header init (first write determines column order)
            if not self._header_written:
                self._writer = csv.DictWriter(self._file, fieldnames=sorted(row.keys()))
